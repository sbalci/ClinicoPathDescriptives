...
tableone2Options <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "tableone2Options",
...
tableone2Base <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "tableone2Base",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(0,0,3),
                options = options,
                results = tableone2Results$new(options=options),
                data = data,
                datasetId = datasetId,
