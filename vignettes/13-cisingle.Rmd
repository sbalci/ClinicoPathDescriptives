...
>
> **`ciSingle()` — Confidence Intervals for Mean Values — is under development and is not
...
>
> For released summaries of continuous variables in this module today, see `summarydata` and
> `tableone`.
...
```{r setup}
# NOTE: ciSingle() is NOT exported by ClinicoPathDescriptives 1.0.52.
