...
> not exported.
>
> This vignette moved here from the jjstatsplot collection, where it was written against
> the earlier name `jjriverplot`. The analysis lives in this module's family, so the
> documentation follows it. Option names and defaults may still change before it ships.
