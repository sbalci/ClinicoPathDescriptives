...
>
> **`groupsummary` ("Group and Summarize") is NOT part of ClinicoPathDescriptives 1.0.52.**
>
...
>
> **It is under development and planned for a future release.** Until then `groupsummary()`
...
> For descriptive summaries that ARE available today, see `summarydata`, `tableone` and
> `reportcat`.
