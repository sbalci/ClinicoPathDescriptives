...
vignette: >
  %\VignetteIndexEntry{Vignette: Generating Quick Summaries of Categorical Pathology Data}
...
# `vars` is reportcat's only option - there is no grouping or sub-setting argument.
results <- reportcat(
    data = crc_cases,
