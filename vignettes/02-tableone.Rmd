...
vignette: >
  %\VignetteIndexEntry{Vignette: Generating a 'Table 1' with ClinicoPathDescriptives}
...
results <- tableone(
    ...
    sty = "t2",  # t1 = tableone (default), t2 = gtsummary, t3 = arsenal, t4 = janitor
    excl = FALSE # Do not exclude NAs for this example to show how they are handled
)
# tableone() accepts only: vars, sty, excl, showSummary, showAbout, showReportSentence.
