...
>
> **`enhancedtables` is NOT part of ClinicoPathDescriptives 1.0.52.**
>
...
>
> **It is under development and planned for a future release.** Until then `enhancedtables()`
> cannot be called from this package. All code blocks below are plain fenced display blocks
> rather than knitr chunks, so nothing here is executed at build time; the options they show
> describe the in-development version, not a released API.
>
